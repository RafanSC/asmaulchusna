...
LIST=$(curl -sS https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/license/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/license/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/license/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/license/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/license/key | grep $kode | awk '{print $6}')
cd
...
echo "### $author $hhari $MYIP @wongedan_kuwibebas" >> penak
...
"'&reply_markup={"inline_keyboard":[[{"text":"🛂ᴏʀᴅᴇʀ","url":"https://t.me/wongedan_kuwibebas"},{"text":"🎲GRUP","url":"https://t.me/tesautoesce"}]]}'
