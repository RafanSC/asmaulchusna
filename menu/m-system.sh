...
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "     \033[0;36mTelegram${NC}: https://t.me/RafanSTR18"
        echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" | lolcat
        exit
    fi
}
...
clear
echo -e  "$COLOR1┌──────────────────────────────────────────┐${NC}" | lolcat
echo -e  "$COLOR1│  \033[1;37mContoh subdomain xxx.vipme.my.id        $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1│    \033[1;37mxxx jadi subdomain kamu               $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1└──────────────────────────────────────────┘${NC}" | lolcat
echo " "
...
clear
echo -e  "$COLOR1┌──────────────────────────────────────────┐${NC}" | lolcat
echo -e  "$COLOR1│  \033[1;37mContoh subdomain xxx.server-premium.my.id  $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1│    \033[1;37mxxx jadi subdomain kamu               $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1└──────────────────────────────────────────┘${NC}" | lolcat
echo " "
...
clear
echo -e  "$COLOR1┌──────────────────────────────────────────┐${NC}" | lolcat
echo -e  "$COLOR1│             ${WH}TERIMA KASIH                 $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1│        ${WH}SUDAH MENGGUNAKAN SCRIPT          $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1│               ${WH}DARI SAYA                  $COLOR1│${NC}" | lolcat
echo -e  "$COLOR1└──────────────────────────────────────────┘${NC}" | lolcat
echo " "
...
echo -e "\033[42m    ∆ EDAN MANAGER BANDWITH ∆    \033[0m"
echo -e "\033[1;93m──────────────────────────────────────────\033[0m" | lolcat
...
colornow=$(cat /etc/t.me/wongedan_kuwibebas/theme/color.conf)
NC="\e[0m"
COLOR1="$(cat /etc/RafanSC/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/RafanSC/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"
WH='\033[1;37m'
...
echo -e "$COLOR1 ${NC}                ${WH}• WONGEDAN VPN •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" | lolcat
echo -e ""
read -n 1 -s -r -p "   Press any key to back on menu"
menu
...
function check-dns(){
    bash <(curl -sSL https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/install/ceknet.sh)
read -n 1 -s -r -p "   Press any key to back on menu"
menu
}
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/RafanSC/dobot/master/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
...
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" | lolcat
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• ADMIN MENU •                 ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" | lolcat
echo -e "$COLOR1                                                    ${NC} $COLOR1 $NC"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" | lolcat
echo -e "  ${WH}[${COLOR1}77${WH}]${NC} ${COLOR1}• ${WH}MENU REGISTRASI IP${WH}     $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" | lolcat
echo -e ""
echo -ne " ${WH}Select menu ${COLOR1}: ${WH}"; read opt
case $opt in
